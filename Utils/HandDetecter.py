...
class HandDetected(object):
    def __init__(self):
        ...
        self.Hand = self.mpHand.Hands(min_detection_confidence=0.60,min_tracking_confidence=0.5)
    ...
    def __str__(self):
        return "HandDetected for Identify Hands"
